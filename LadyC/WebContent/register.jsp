  ...
  <div class="header-top">
   ...
   <div class="header-bottom">
    		   ...
    		   <form method="post" action="RegistrationController">
    			 <div class="col_1_of_2 span_1_of_2">
		   			 <div><input type="text" name="username" value="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}"></div>
		    				<div><input type="text" name ="pwd" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'password';}"></div>
		    			<div><input type="text" name ="fisrtname" value="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}"></div>
		    			<div><input type="text" name ="lastname" value="Last Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone';}"></div>
		    	  ...
		    	  <div class="col_1_of_2 span_1_of_2">	
		    		...
		    		<div><input type="text" name="city" value="City" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"></div>
		    		<div><select id="state" name="state" value="State" onchange="change_country(this.value)" class="frm-field required">
	...
	<option value="WY">Wyoming</option>
		         ...
		         <div><input type="text" name ="phone" value="Phone Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone';}"></div>
